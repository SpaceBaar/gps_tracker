...
import com.sheelainfotech.gpstracker.app.AppConfig;
import com.sheelainfotech.gpstracker.app.AppController;
...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginActivity.this, GpsTrackerActivity.class);
